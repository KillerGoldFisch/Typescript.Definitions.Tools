...
namespace Typescript.Definitions.Tools2.Tests
{
    public class TsGeneratorTests
    {
        ...
        public void WhenClassIsReferenced_FullyQualifiedNameIsUsed()
        {
            ...
            Assert.Contains("PrimaryAddress: Typescript.Definitions.Tools2.Tests.TestModels.Address", script);
            Assert.Contains("Addresses: Typescript.Definitions.Tools2.Tests.TestModels.Address[]", script);
        }
        ...
        public void WhenClassWithEnumReferenced_FullyQualifiedNameIsUsed()
        {
            ...
            Assert.Contains("Type: Typescript.Definitions.Tools2.Tests.TestModels.ItemType", script);
        }
