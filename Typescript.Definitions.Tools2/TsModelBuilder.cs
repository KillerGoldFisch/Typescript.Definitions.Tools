...
using Typescript.Definitions.Tools2.Extensions;
...
namespace Typescript.Definitions.Tools2
{
    ...
    {
        public Dictionary<Type, TsClass> Classes { get; } = new Dictionary<Type, TsClass>();

        public Dictionary<Type, TsEnum> Enums { get; } = new Dictionary<Type, TsEnum>();
